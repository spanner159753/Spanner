...
- [1.4.0](https://app.slacker.pub/static/image/spanner.apk) Open some dapps for free .
- [1.3.0](https://app.slacker.pub/static/image/spanner.apk) Provide more dapp automation, such as MiningNetwork, TycoonPlan.
